...
const PlanetDetail: React.FC = () => {
  ...
  const getContent = () => {
    switch (activeTab) {
      case 'overview': return currentPlanet.overview;
      case 'structure': return currentPlanet.structure;
      case 'geology': return currentPlanet.geology;
    }
  };
      ...
      <div className="planet-detail-top">
        ...
        <div className="planet-info-wrapper">
          ...
          <p className="planet-source">
            Source: <a href={content.source} target="_blank" rel="noopener noreferrer">Wikipedia</a>
          </p>
          <Tabs />
        </div>
      </div>
